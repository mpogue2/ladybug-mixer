...
/* I2C address
 * address: 7 bit slave address, left aligned, bits 7:1 are used, LSB bit is not
 * used
 */
 ...
 * @note   This function must be called each time you do some changes to LCD, to
 * update buffer from RAM to LCD
 */
void SSD1306_UpdateScreen(void);

/**
 * @brief  Toggles pixels invertion inside internal RAM
 * @note   @ref SSD1306_UpdateScreen() must be called after that in order to see
 * updated LCD screen
 */
 ...
 * @note   @ref SSD1306_UpdateScreen() must be called after that in order to see
 * updated LCD screen
 * @param  Color: Color to be used for screen fill. This parameter can be a
 ...
 * @note   @ref SSD1306_UpdateScreen() must called after that in order to see
 * updated LCD screen
 * @param  x: X location. This parameter can be a value between 0 and
 * SSD1306_WIDTH - 1
 * @param  y: Y location. This parameter can be a value between 0 and
 * SSD1306_HEIGHT - 1
 * @param  color: Color to be used for screen fill. This parameter can be a
 * value of @ref SSD1306_COLOR_t enumeration
 * @retval None
 ...
 * @param  c: Color to be used. This parameter can be a value of @ref
